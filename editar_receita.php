<html>
	<head>
		...
		<title>Editando [Nome Da Receita]</title>
	</head>
	<body>
		<header class="header">
		...
		<main>
			...
			<form action="" method="POST" class="formulario" enctype="multipart/form-data">
				<div class="campo">
					...
					<input type="text" class="campo__texto" id="nome" name="nome" placeholder="O novo nome público da receita será o mesmo que você digitar aqui">
				</div>
				<div class="imagem-antiga" style="background-image: url('');">
				...
				<div class="campo campo--grande">
					...
					<textarea class="campo__texto" name="descricao" id="descricao" placeholder="Adicione uma nova descricao para sua receita"></textarea>
					...
					<ul class="ingredientes__lista">
						<li class="ingredientes__linha">
							<div class="campo campo--pequeno">
								...
								<input type="text" class="campo__texto" name="medida" placeholder="Ex: 3 unidades de">
							</div>
							<div class="campo campo--pequeno">
				...
				<div class="campo campo--grande">
					...
					<textarea class="campo__texto" name="preparo" id="preparo" placeholder="Mude a descrição do modo de preparo da sua receita"></textarea>
					<div class="campo__bandeja"></div>
				</div>
