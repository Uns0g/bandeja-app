<html>
	<head>
		...
		<title>[Nome Da Receita - Usuario]</title>
	</head>
	<body>
		<header class="header">
		...
		<main class="receita">
			<h2 class="titulo">Receita Qualquer</h2>
			<div class="receita__foto" style="background-image: url('https://images.unsplash.com/photo-1519077336050-4ca5cac9d64f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80');"></div>
			<section class="informacao">
				<div class="informacao__box">
					<i class="informacao__icone ri-star-fill"></i>
					<span class="informacao__texto">
						<strong class="receita__numero-favoritos"></strong>
						Favoritos
					</span>
				</div>
				<div class="informacao__box">
					...
					<span class="informacao__texto">
						<strong class="receita__autor">Qualquer Autor</strong>
					</span>
				</div>
				<div class="informacao__box">
					<i class="informacao__icone ri-timer-line"></i>
					<span class="informacao__texto">15 min</span>
				</div>
				<div class="informacao__box">
					<i class="informacao__icone ri-pie-chart-2-line"></i>
					<span class="informacao__texto">3 Porções</span>
				</div>
			</section>
			...
			<div class="campo">
				...
				<div class="campo__conteudo">
					Non odit occaecati itaque iusto quisquam mollitia. Fugit nihil reiciendis quia molestiae qui ipsum ut. Impedit et dolores sunt atque minus perspiciatis quam.
				</div>
